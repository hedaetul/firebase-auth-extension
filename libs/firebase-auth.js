...
class ke {
  ...
  static fromJSON(e, t) {
    ...
    return (
      n &&
        (B('string' == typeof n, 'internal-error', { appName: e }),
        (s.refreshToken = n)),
      i &&
        (B('string' == typeof i, 'internal-error', { appName: e }),
        (s.accessToken = i)),
      r &&
        (B('number' == typeof r, 'internal-error', { appName: e }),
        (s.expirationTime = r)),
      s
    );
  }
...
class rt extends Ye {
  ...
  _linkToIdToken(e, t) {
    return (async function (e, t) {
      ...
      if (n.temporaryProof)
        throw pe(e, 'account-exists-with-different-credential', n);
      return n;
...
class dt extends ut {
  static credentialFromJSON(e) {
    const t = 'string' == typeof e ? JSON.parse(e) : e;
    return (
      B('providerId' in t && 'signInMethod' in t, 'argument-error'),
      nt._fromParams(t)
    );
  }
  credential(e) {
...
(lt.FACEBOOK_SIGN_IN_METHOD = 'facebook.com'),
  (lt.PROVIDER_ID = 'facebook.com');
class ht extends ut {
  constructor() {
...
function wt(e, t, n, i) {
  return (
    ...
    if ('auth/multi-factor-auth-required' === n.code)
      throw Tt._fromErrorAndOperation(e, n, t, i);
    throw n;
  });
}
function Et(e) {
...
function Mt(e, t, n) {
  ...
  B(
    ...
    n.iOS &&
      (B(n.iOS.bundleId.length > 0, e, 'missing-ios-bundle-id'),
...
async function Gt(e, t, n) {
  ...
  return (
    B(r._tenantId === (i.tenantId || null), i, 'tenant-id-mismatch'), Nt(i, r)
  );
}
    ...
    : (function (e) {
        ...
        if (!i && (null == e ? void 0 : e.idToken)) {
          const i =
            null ===
              (n =
                null === (t = _e(e.idToken)) || void 0 === t
                  ? void 0
                  : t.firebase) || void 0 === n
              ? void 0
              : n.sign_in_provider;
          if (i)
            return new Zt(s, 'anonymous' !== i && 'custom' !== i ? i : null);
        }
        if (!i) return null;
        switch (i) {
          case 'facebook.com':
  ...
  static _fromError(e, t) {
    ...
    return new gn(s, r, async (e) => {
      ...
      switch (t.operationType) {
        ...
        case 'reauthenticate':
          return (
            B(t.user, n, 'internal-error'),
            _t._forOperation(t.user, t.operationType, o)
          );
        default:
          j(n, 'internal-error');
      }
      ...
      e._onReload((t) => {
        t.mfaInfo &&
          (this.enrolledFactors = t.mfaInfo.map((t) =>
            Dt._fromServerResponse(e.auth, t)
          ));
      });
  }
  static _fromUser(e) {
...
class wn extends Tn {
  ...
  onStorageEvent(e, t = !1) {
    ...
    He() && r !== e.newValue && e.newValue !== e.oldValue
      ? setTimeout(i, 10)
      : i();
  }
  notifyListeners(e, t) {
...
function On() {
  return (
    void 0 !== Nn().WorkerGlobalScope && 'function' == typeof Nn().importScripts
  );
}
...
class jn {
  ...
  render(e, t) {
    ...
    return (
      this._widgets.set(n, new qn(e, this.auth.name, t || {})),
      this.counter++,
      n
    );
  }
...
class Gn {
  constructor() {
    ...
    (this.hostLanguage = ''),
      (this.counter = 0),
      (this.librarySeparatelyLoaded = !!(null === (e = Nn().grecaptcha) ||
      void 0 === e
        ? void 0
        : e.render));
  }
...
function ni(e, t) {
  return t
    ? Y(t)
    : (B(e._popupRedirectResolver, e, 'argument-error'),
          ...
          if (
            ...
            if (!(null === (s = Nn().gapi) || void 0 === s ? void 0 : s.load)) {
              ...
              return (
                ...
                xn(`https://apis.google.com/js/api.js?onload=${t}`).catch((e) =>
                  n(e)
                )
              );
            }
...
function qi(e, t, n, i = 500, r = 600) {
  ...
  const u = Object.assign(Object.assign({}, Hi), {
    ...
    d = a().toLowerCase();
  n && (c = Le(d) ? '_blank' : n),
    Pe(d) && ((t = t || 'http://localhost'), (u.scrollbars = 'yes'));
...
const zi = class {
  ...
  _initialize(e) {
    ...
    if (this.eventManagers[t]) {
      ...
      return e
        ? Promise.resolve(e)
        : ($(n, 'If manager is not set, promise should be'), n);
    }
  ...
  _originValidation(e) {
    ...
    return (
      this.originValidationPromises[t] ||
        (this.originValidationPromises[t] = Oi(e)),
      this.originValidationPromises[t]
    );
  }
...
function Xi(t = i()) {
  ...
  const a =
    ((c = 'auth'),
    null ===
      (h = null === (l = u()) || void 0 === l ? void 0 : l.emulatorHosts) ||
    void 0 === h
      ? void 0
      : h[c]);
  var c, l, h;
      ...
      (e, { options: t }) => {
        ...
        return ((e, n) => {
          B(r && !r.includes(':'), 'invalid-api-key', { appName: e.name }),
            B(!(null == s ? void 0 : s.includes(':')), 'argument-error', {
              appName: e.name,
            });
          const i = {
              apiKey: r,
